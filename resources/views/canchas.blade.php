...
<body class="font-body text-[15px] overflow-x-hidden">
  ...
  <header class="fixed top-0 w-full z-50 bg-surface border-b border-outline-variant">
    <nav class="flex justify-between items-center px-gutter h-16 max-w-container-max mx-auto">
      ...
      <div class="hidden md:flex items-center gap-xl">
        ...
        <a class="text-on-surface border-b-2 border-accent pb-1 text-sm font-medium" href="{{ url('/canchas') }}"
          aria-current="page">Canchas</a>
        <a class="text-on-surface-variant hover:text-on-surface transition-colors text-sm font-medium"
      ...
      <div class="flex items-center gap-sm">
        <div class="relative hidden sm:block">
          ...
          <input id="search-op"
            ...
            placeholder="Buscar cancha…" type="text" />
        </div>
  ...
  <div id="mobile-menu"
    ...
    <div class="flex flex-col p-gutter gap-xs">
      ...
      <a href="{{ url('/canchas') }}"
        class="px-4 py-3 rounded-lg bg-primary-container text-on-primary-container font-medium">Canchas</a>
      <a href="{{ url('/tiendas') }}"
    ...
    <div class="max-w-container-max mx-auto py-lg">
      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-md mb-xl">
        <div>
          <h1 class="font-display text-3xl sm:text-4xl text-on-surface uppercase tracking-tight mb-xs">Directorio de
            Canchas</h1>
          <p class="font-mono text-[11px] text-primary tracking-[0.15em] uppercase">Infraestructura táctica — sector
            Chile</p>
        </div>
        <div class="flex gap-sm">
          <span
            class="bg-surface-container-high px-3 py-1.5 rounded border border-outline-variant font-mono text-[12px]">Total:
            42</span>
          <span
            class="bg-primary-container px-3 py-1.5 rounded border border-primary/40 font-mono text-[12px] text-primary">Operativos:
            38</span>
        </div>
      </div>
      ...
      <div class="grid grid-cols-12 gap-lg">
        ...
        <aside class="col-span-12 md:col-span-3 space-y-lg">
          <section class="bg-surface-container p-md border border-outline-variant rounded-lg" aria-label="Filtros">
            ...
            <div class="space-y-md">
              <div>
                <label for="filter-region-campos"
                  class="font-mono text-[11px] text-on-surface-variant uppercase mb-1.5 block">Región</label>
                <select id="filter-region-campos"
                  class="w-full bg-surface-container-low border border-outline-variant rounded text-on-surface text-sm py-2 px-2 focus:border-accent focus:ring-0">
              ...
              <button
                class="w-full border border-outline-variant hover:bg-accent hover:text-on-accent hover:border-accent transition-colors font-mono text-[12px] py-2.5 rounded uppercase tracking-wide">
                Aplicar filtros
              </button>
            </div>
          </section>
          ...
          <section class="bg-surface-container border border-outline-variant rounded-lg overflow-hidden">
            <div
              class="p-2.5 bg-surface-container-high border-b border-outline-variant flex justify-between items-center">
            ...
            <div class="h-40 relative grayscale contrast-125 opacity-90">
              ...
              <img class="w-full h-full object-cover"
                alt="Vista satelital de Santiago, Chile, mostrando el sector de campos de airsoft."
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuC4TFxwrO025kgiB4ne6fIyilejNxHTFnN3Dn5PVpYiAB8N9lfAIvwPpzbaFLWPKKsfgDMS_wu9LkFtbz1JGHRGpP-9vThBOvct1RNEMATdED-Mm6CfhRGtzq5IYEnrE_aASdKG8MWXi6X9eFJYxE2_XEuvG149RFgd_WwndaBMCPsufJRdn41sjjnur5DNC8jbjtCO6XC8yUvFvETbwkySM3vztHFMzhb_SZCzMDimaVvGG7oJNnafjw" />
              <span class="absolute top-2 left-2 w-2 h-2 bg-accent rounded-full animate-pulse"></span>
            </div>
            <div class="p-md text-center">
              <button class="font-mono text-[12px] text-primary hover:underline uppercase tracking-wide">Abrir mapa
                táctico</button>
            </div>
          </section>
        </aside>
        ...
        <div class="col-span-12 md:col-span-9 grid grid-cols-1 md:grid-cols-2 gap-lg">
          ...
          <!-- Featured field -->
          <article
            class="md:col-span-2 group bg-surface-container border border-outline-variant rounded-lg overflow-hidden hover:border-primary/50 transition-colors">
            <div class="flex flex-col md:flex-row">
              <div class="w-full md:w-2/5 relative overflow-hidden h-56 md:h-auto">
                <img class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  alt="Bodega industrial reconvertida en un campo de airsoft CQB en Chile, con iluminación verde y ámbar dramática."
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBUqRpsVmlc7lCPfYml4qSZxAjycU4X5nLlFLMVJFEeYD6M4uGFGN7alZeSgDUC8xK59RNBVd43CA1TZhHgtcDMZbmYmLLUIXP3e0KSOUdcF2nPETEFJCo-HlGHUJwgpjHrZDcS9K1bVTHj-wVL00XorAoNp92McNu4U5VKl9z45BNIfg3bPUvzfPDkSAxjIQQhq6lSNlUDKPL5Dm48ZES8GLWx8vSrJv9lGlMyl9XOUcokaofVMEkM-w" />
                <span
                  class="absolute top-3 left-3 bg-accent text-on-accent font-mono text-[11px] px-2.5 py-1 rounded uppercase font-semibold">Destacado</span>
              </div>
              <div class="p-lg flex-1 flex flex-col justify-between">
                <div>
                  <div class="flex justify-between items-start gap-2 mb-1">
                    <h2
                      class="font-display text-2xl text-on-surface uppercase leading-tight group-hover:text-primary transition-colors">
                      The Warehouse CQB</h2>
                  ...
                  <p class="font-mono text-[12px] text-primary uppercase tracking-widest mb-md">Santiago — sector norte
                  </p>
                  <p class="text-sm text-on-surface-variant mb-lg leading-relaxed">Cancha cerrada de alto nivel con dos
                    pisos, zonas de oficinas y vehículos reales. Protocolos de seguridad estrictos y cronograma
                    obligatorio.</p>
                  <div class="flex flex-wrap gap-2 mb-lg">
                    <span
                      class="bg-surface-container-high border border-outline-variant px-2.5 py-1 font-mono text-[11px] uppercase rounded">Límite
                      350 FPS</span>
                    <span
                      class="bg-surface-container-high border border-outline-variant px-2.5 py-1 font-mono text-[11px] uppercase rounded">Zona
                      tech</span>
                    <span
                      class="bg-surface-container-high border border-outline-variant px-2.5 py-1 font-mono text-[11px] uppercase rounded">Arriendo
                      disponible</span>
                  </div>
                </div>
                <div class="flex gap-md pt-md border-t border-outline-variant">
                  <button
                    class="flex-1 bg-primary text-on-primary font-mono text-[12px] py-3 rounded uppercase tracking-wide hover:brightness-110 transition-all active:scale-95">Agendar
                    misión</button>
                  <button aria-label="Ver ubicación"
                    class="px-4 border border-outline-variant text-on-surface-variant hover:text-primary hover:border-primary rounded transition-colors">
          ...
          <!-- Field 2 -->
          <article
            class="bg-surface-container border border-outline-variant rounded-lg overflow-hidden group hover:border-primary/50 transition-colors">
            <div class="h-44 relative overflow-hidden">
              <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                alt="Amplio campo de airsoft woodland en el sur de Chile con búnkeres y trincheras de madera entre pinos."
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAhheEweDgC40TWYpVus1M7jtNv_x6G32NpVsd9KoHpgxrcicgxLlKKf_xMP2F6Z89si0rZ7Wq7ynP_2D5X_fegqi8olus0QLc7M8bRsSiVQQSS_8CGqAfaYIRZAILYXjGEN0hS94GC2zhnaEvhMZfz_Rqi8ViuuDpr_DBnJq7xbWkflJgXzT7fv_QHRMasZ8UC3EwBxJkbTW-Ctq7kOrFdpcTCrMR2kRLcPE8Hui4KHxXgqvtBPsz8OQ" />
              <span
                class="absolute top-3 right-3 bg-surface/90 backdrop-blur px-2 py-1 font-mono text-[10px] text-primary uppercase border border-primary/30 rounded">Woodland</span>
            </div>
            <div class="p-md">
              <h3 class="font-display text-lg text-on-surface uppercase leading-tight mb-1">Operación Trinchera</h3>
              <p class="font-mono text-[11px] text-on-surface-variant mb-md uppercase tracking-wide">Talca — VII Región
              </p>
              <div class="flex justify-between items-center pt-md border-t border-outline-variant">
                ...
                <button
                  class="text-sm text-on-surface-variant hover:text-primary uppercase flex items-center gap-1 transition-colors">Detalles
          ...
          <article
            ...
            <div class="h-44 relative overflow-hidden">
              <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                alt="Centro urbano de simulación de airsoft de varios niveles con estructuras de concreto y contenedores."
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCncJD-3rUNVWfuSkDzPGiCGl4T9upu1pZFP6Gu2f0YUyw--DAAbbbQdnkSO1ezRU2bfgD8Q1ybmBbG0QUPLrcmPwvRzmg7-7NHXLeLkJxibEW1x5waqGv0lFO1m4mWKnxUp3YyyqNYNagY2_2tB_tEBehr2RHuzyk2alYRFpprWJNtzyS3ciDjae1RE1tf4DHNQU_1Q08BD8cnqug7MrVh1_8iSnIdfQ0bb6dQNkp-t4-ndoQkm9W77A" />
              <span
                class="absolute top-3 right-3 bg-surface/90 backdrop-blur px-2 py-1 font-mono text-[10px] text-primary uppercase border border-primary/30 rounded">Arena
                mixta</span>
            </div>
            <div class="p-md">
              <h3 class="font-display text-lg text-on-surface uppercase leading-tight mb-1">Sector 7 Urban</h3>
              <p class="font-mono text-[11px] text-on-surface-variant mb-md uppercase tracking-wide">Puente Alto — RM
              </p>
              <div class="flex justify-between items-center pt-md border-t border-outline-variant">
          ...
          <article
            ...
            <div class="h-44 relative overflow-hidden">
              <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                alt="Campo de airsoft verde en una zona rural de Chile con graneros antiguos, iluminado por el atardecer."
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuB5rWoCwIdNM0NLeXZw0CmbwUJmeUDmuMTr4ELAT-rqW-TERoNWEE-8D0T5dAbevXNqCKAtZkxuM1kihiwOyzVn39eGDuERTH96U2PjHYZBkTqT7Ofdndj0ORN42k5R3iNYT4ynVlxXlEMYr0RsWGZgivD5KDxjxfWB_-kblXC_3eyAf1EkvWl154_k6ze0rPPGG7NIvkjq87HjaeCxe6EeE_YvbDXFRWnzJtMxJLz4L-3MkoCXjf0d6Q" />
              <span
                class="absolute top-3 right-3 bg-surface/90 backdrop-blur px-2 py-1 font-mono text-[10px] text-primary uppercase border border-primary/30 rounded">Campo
                abierto</span>
            </div>
            <div class="p-md">
          ...
          <article
            ...
            <div class="h-44 relative overflow-hidden">
              <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                alt="Estacionamiento subterráneo convertido en una arena de airsoft CQB de alta intensidad con luces de neón."
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAgWmR5A3YkHZWX_3dlDJ4kJ7ljRkkl5rURZD9X_irau5kzvUB85qTh6V-l331KaT7cI-0YsLBvRVW2hy7sq2UC80FW2r6v_xHbq4b_wPvyB9DAvS5flEiP0nUmFSe0S2zaUCMsWLuH8iLJvdvpa3HpVgP5rdbLxGs3AAPN7rPmnXvRkXHQ8xuLIeZxL8UOByLNWLuZuFtFTxVdlKiGey6-hh4h3qX5VCKoioQq03VJMpjG99EuMoLfsw" />
              <span
                class="absolute top-3 right-3 bg-surface/90 backdrop-blur px-2 py-1 font-mono text-[10px] text-primary uppercase border border-primary/30 rounded">Ultra
                CQB</span>
            </div>
            <div class="p-md">
              <h3 class="font-display text-lg text-on-surface uppercase leading-tight mb-1">Bunker Subterráneo</h3>
              <p class="font-mono text-[11px] text-on-surface-variant mb-md uppercase tracking-wide">Providencia — RM
              </p>
              <div class="flex justify-between items-center pt-md border-t border-outline-variant">
  ...
  <nav
    ...
    <a href="{{ url('/canchas') }}" class="flex flex-col items-center gap-0.5 text-accent" aria-current="page">

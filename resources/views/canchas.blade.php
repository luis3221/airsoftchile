...
<header class="fixed top-0 w-full z-50 bg-surface border-b border-outline-variant">
  <nav class="flex justify-between items-center px-gutter h-16 max-w-container-max mx-auto">
    ...
    <div class="hidden md:flex items-center gap-xl">
      ...
      <a class="text-on-surface border-b-2 border-accent pb-1 text-sm font-medium" href="#" aria-current="page">Campos</a>
      <a class="text-on-surface-variant hover:text-on-surface transition-colors text-sm font-medium" href="#">Tiendas</a>
    </div>
    <div class="flex items-center gap-sm">
      <div class="relative hidden sm:block">
        <label for="search-op" class="sr-only">Buscar campo</label>
        ...
        <input id="search-op" class="bg-surface-container-low border border-outline-variant rounded text-on-surface text-sm py-2 pl-9 pr-3 focus:border-accent focus:ring-0 w-48 font-mono placeholder:text-on-surface-variant/60" placeholder="Buscar campo…" type="text"/>
      </div>
...
<div id="mobile-menu" class="fixed inset-x-0 top-[6.5rem] z-40 md:hidden bg-surface-container border-b border-outline-variant -translate-y-[150%] opacity-0 pointer-events-none">
  <div class="flex flex-col p-gutter gap-xs">
    ...
    <a href="#" class="px-4 py-3 rounded-lg bg-primary-container text-on-primary-container font-medium">Campos</a>
...
<aside class="hidden lg:flex flex-col fixed left-0 top-[6.5rem] h-[calc(100%-6.5rem)] z-30 bg-surface-container border-r border-outline-variant w-60">
  ...
  <nav class="flex-1 flex flex-col gap-xs p-2 pt-md">
    ...
    <a class="bg-primary-container text-on-primary-container rounded-lg px-4 py-3 flex items-center gap-md text-sm font-medium" href="#" aria-current="page">
      <span class="material-symbols-outlined text-[20px] fill-icon">map</span> Campos
    </a>
...
<main class="lg:pl-60 pt-[6.5rem] pb-24 lg:pb-12 px-gutter grid-overlay min-h-screen">
  <div class="max-w-container-max mx-auto py-lg">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-md mb-xl">
      <div>
        <h1 class="font-display text-3xl sm:text-4xl text-on-surface uppercase tracking-tight mb-xs">Directorio de campos</h1>
          ...
          <div class="space-y-md">
            ...
            <fieldset>
              ...
              <div class="space-y-2">
                ...
                <label class="flex items-center gap-2 cursor-pointer group">
                  <input class="rounded border-outline-variant bg-surface-container" type="checkbox"/>
                  <span class="text-sm group-hover:text-primary transition-colors">Campo abierto</span>
                </label>
              </div>
            </fieldset>

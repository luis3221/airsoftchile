  ...
  <nav class="flex justify-between items-center px-gutter h-16 max-w-container-max mx-auto">
    ...
    <div class="flex items-center gap-sm">
      <div class="relative hidden sm:block">
        ...
        <input id="search-tiendas" class="bg-surface-container-low border border-outline-variant rounded text-on-surface text-sm py-2 pl-9 pr-3 focus:border-accent focus:ring-0 w-48 font-mono placeholder:text-on-surface-variant/60" placeholder="Buscar tiendas…" type="text"/>
      </div>
...
<main class="lg:pl-60 pt-[6.5rem] pb-24 lg:pb-12 px-gutter grid-overlay min-h-screen">
  <div class="max-w-container-max mx-auto py-lg">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-md mb-xl">
      <div>
        <h1 class="font-display text-3xl sm:text-4xl text-on-surface uppercase tracking-tight mb-xs">Directorio de tiendas</h1>
        <p class="text-on-surface-variant leading-relaxed">Red de proveedores tácticos autorizados en todo el territorio nacional.</p>
      </div>
      <div class="flex gap-sm">
        <span class="px-3 py-1.5 bg-surface-container-high border border-outline-variant text-primary font-mono text-[12px] rounded">34 activas</span>
        <span class="px-3 py-1.5 bg-accent-container border border-accent/40 text-accent font-mono text-[12px] rounded">Envíos nacionales</span>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-lg">
      ...
      <aside class="md:col-span-3 space-y-lg">
        <section class="bg-surface-container border border-outline-variant p-md rounded-lg space-y-md" aria-label="Filtrar por región">
          ...
          <div class="space-y-2">
            <label class="flex items-center gap-2 cursor-pointer group">
              ...
              <span class="text-sm text-on-surface-variant group-hover:text-on-surface transition-colors">Metropolitana</span>
            </label>
            <label class="flex items-center gap-2 cursor-pointer group">
              <input class="rounded border-outline-variant bg-surface-container-high" type="checkbox"/>
              <span class="text-sm text-on-surface-variant group-hover:text-on-surface transition-colors">Valparaíso</span>
            </label>
            <label class="flex items-center gap-2 cursor-pointer group">
              <input class="rounded border-outline-variant bg-surface-container-high" type="checkbox"/>
              <span class="text-sm text-on-surface-variant group-hover:text-on-surface transition-colors">Biobío</span>
            </label>
            <label class="flex items-center gap-2 cursor-pointer group">
              <input class="rounded border-outline-variant bg-surface-container-high" type="checkbox"/>
              <span class="text-sm text-on-surface-variant group-hover:text-on-surface transition-colors">Araucanía</span>
            </label>
          </div>
        </section>

        <section class="bg-surface-container border border-outline-variant p-md rounded-lg space-y-md" aria-label="Filtrar por categoría">
          <h2 class="font-display text-lg text-primary uppercase border-b border-outline-variant pb-2">Categoría</h2>
          <div class="flex flex-wrap gap-1.5">
            <button class="px-2.5 py-1 bg-surface-container-high text-on-surface border border-outline-variant text-[11px] uppercase font-medium rounded hover:border-primary transition-colors">AEG</button>
            <button class="px-2.5 py-1 bg-surface-container-high text-on-surface border border-outline-variant text-[11px] uppercase font-medium rounded hover:border-primary transition-colors">GBB</button>
            <button class="px-2.5 py-1 bg-surface-container-high text-on-surface border border-outline-variant text-[11px] uppercase font-medium rounded hover:border-primary transition-colors">Equipo</button>
            <button class="px-2.5 py-1 bg-surface-container-high text-on-surface border border-outline-variant text-[11px] uppercase font-medium rounded hover:border-primary transition-colors">Taller</button>
            <button class="px-2.5 py-1 bg-surface-container-high text-on-surface border border-outline-variant text-[11px] uppercase font-medium rounded hover:border-primary transition-colors">Ópticas</button>
          </div>
        </section>

        <!-- Promo -->
        <a href="#" class="relative overflow-hidden rounded-lg border border-outline-variant h-56 flex items-end p-md group block">
          <div class="absolute inset-0 bg-gradient-to-t from-surface to-transparent z-10"></div>
          <img class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Réplica de airsoft MK18 personalizada sobre una mesa de trabajo de fibra de carbono, iluminada con luz ámbar." src="https://lh3.googleusercontent.com/aida-public/AB6AXuA0jU_jxXCHnd9tY3MQGA0UMj3Y5G85ychQ8ouqNe6zIdBzqIU2xdEH-EPziGgiR0gyYo6u9ugfG8R02mDV-3Vsjl1QbnggJkDghcw86a66qPjRyIpBkLqqiE21jfrffkX2JIC2Z_Cj-tUiQFbJToD79m5Hx7pIGF23_nKUOw_ntLT5a9RSuEr3YnOy9wQR1MYJFwmvuxJ3fJDzOk-m817De7cHtldPjldftz2znJnfFekT6qxWsVrzkw"/>
      ...
      <div class="md:col-span-9 grid grid-cols-1 xl:grid-cols-2 gap-lg">
        ...
        <!-- Store 1 -->
        <article class="bg-surface-container border border-outline-variant rounded-lg overflow-hidden flex flex-col group hover:border-primary/50 transition-colors">
          ...
          <div class="p-md flex flex-col sm:flex-row gap-md">
            <div class="w-full sm:w-28 h-28 bg-surface border border-outline-variant rounded-lg overflow-hidden shrink-0">
              <img class="w-full h-full object-contain p-2" alt="Logo de la tienda Tactical Santiago, un casco espartano geométrico estilizado con una mira de rifle." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDCjKRUOs9JPESY1d5bvIq4R5EKEfSGH5u8-E0MIuAqxNeoFSg5ovDIe7uY872KEvIMyH-_aaTRXBP8LgtnzJPqaEgJ3xVgTr5mbcw9-zjABc7CazOfRkkx-R63clQv1qWqLDBiztQjgMQBGWJa5LhAkmguVL_b2iZrMFrp-rt7ftoKOUzTKzh1EEsgLc0oOs21O6Hqp2KZJVySU6Yd_cB1BpBY5HtuH9h6W7uNw0uxoqTblsGRgkxNMQ"/>
            </div>
            <div class="flex-1 space-y-2 min-w-0">
              ...
              <div class="flex flex-wrap gap-1.5">
                <span class="px-1.5 py-0.5 bg-primary-container text-on-primary-container text-[10px] font-semibold rounded border border-primary/30">AEG Expert</span>
                <span class="px-1.5 py-0.5 bg-surface-container-high text-on-surface-variant text-[10px] font-semibold rounded border border-outline-variant">GBB Specialist</span>
              </div>
              <p class="text-sm text-on-surface-variant line-clamp-2">Distribuidor oficial de marcas premium como G&amp;G, Krytac y Tokyo Marui. Taller certificado in situ.</p>
            </div>
          </div>
          <div class="mt-auto p-md grid grid-cols-2 gap-2 border-t border-outline-variant bg-surface-container-low">
            <button class="flex items-center justify-center gap-1.5 py-2 bg-surface-container-high border border-outline-variant hover:border-primary transition-colors text-on-surface text-sm font-medium rounded">
              <span class="material-symbols-outlined text-[16px]">phone</span> Contactar
            </button>
            <button class="flex items-center justify-center gap-1.5 py-2 bg-accent text-on-accent hover:brightness-110 transition-all text-sm font-medium rounded">
        ...
        <article class="bg-surface-container border border-outline-variant rounded-lg overflow-hidden flex flex-col group hover:border-primary/50 transition-colors">
          ...
          <div class="p-md flex flex-col sm:flex-row gap-md">
            ...
            <div class="flex-1 space-y-2 min-w-0">
              ...
              <div class="flex flex-wrap gap-1.5">
                <span class="px-1.5 py-0.5 bg-primary-container text-on-primary-container text-[10px] font-semibold rounded border border-primary/30">Equipo y nylon</span>
                <span class="px-1.5 py-0.5 bg-surface-container-high text-on-surface-variant text-[10px] font-semibold rounded border border-outline-variant">Outdoor</span>
              </div>
              <p class="text-sm text-on-surface-variant line-clamp-2">Líderes en equipamiento táctico y vestimenta milsim en el sur de Chile. Envíos flash a todo el país.</p>
            </div>
          </div>
          <div class="mt-auto p-md grid grid-cols-2 gap-2 border-t border-outline-variant bg-surface-container-low">
            <button class="flex items-center justify-center gap-1.5 py-2 bg-surface-container-high border border-outline-variant hover:border-primary transition-colors text-on-surface text-sm font-medium rounded">
        ...
        <article class="bg-surface-container border border-outline-variant rounded-lg overflow-hidden flex flex-col group hover:border-primary/50 transition-colors">
          ...
          <div class="p-md flex flex-col sm:flex-row gap-md">
            <div class="w-full sm:w-28 h-28 bg-surface border border-outline-variant rounded-lg overflow-hidden shrink-0">
              <img class="w-full h-full object-contain p-2" alt="Logo de Valpo Tactical Center, una brújula náutica combinada con un riel picatinny." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDB-JO5CB60tOxWpDJ6Cx2e9MVHbxQP6vAemAJLTz-bg2MjHLV5xvdHluIRBU10oIF9Y01DBd53cdT7_vxnD2GlfK2pRTOtnT1EyCV3A6t310c-9DPO1BVzCCVVL5GFWZ-Mdo84nHmbY6WGGAbP2o5KDhj6C-7Kj3LpfT7dAE53YyIc_MCNHK3DEKmg2G3Q6DRAD4n6SYt1WJkMPwplZCPXOh30jy5dFY_rQH9fmLZwRRVSeefMfH77zg"/>
            </div>
            <div class="flex-1 space-y-2 min-w-0">
              <div class="flex justify-between items-start gap-2">
                <div class="min-w-0">
                  ...
                  <p class="text-sm text-on-surface-variant flex items-center gap-1 truncate">
                    <span class="material-symbols-outlined text-[15px] shrink-0">location_on</span> Viña del Mar, Valparaíso
                  </p>
                </div>
                <div class="flex flex-col items-end shrink-0">
              ...
              <div class="flex flex-wrap gap-1.5">
                <span class="px-1.5 py-0.5 bg-primary-container text-on-primary-container text-[10px] font-semibold rounded border border-primary/30">Taller HPA</span>
                <span class="px-1.5 py-0.5 bg-surface-container-high text-on-surface-variant text-[10px] font-semibold rounded border border-outline-variant">Consumibles</span>
              </div>
              <p class="text-sm text-on-surface-variant line-clamp-2">Especialistas en sistemas HPA y personalización de réplicas. Amplio stock de BBs de alta gama.</p>
            </div>
          </div>
          <div class="mt-auto p-md grid grid-cols-2 gap-2 border-t border-outline-variant bg-surface-container-low">
            <button class="flex items-center justify-center gap-1.5 py-2 bg-surface-container-high border border-outline-variant hover:border-primary transition-colors text-on-surface text-sm font-medium rounded">
        ...
        <!-- Add store CTA -->
        <button class="border-2 border-dashed border-outline-variant rounded-lg flex flex-col items-center justify-center p-xl group hover:border-primary transition-colors bg-surface-container/30 text-center">
          ...
          <h3 class="font-display text-lg text-on-surface-variant group-hover:text-on-surface transition-colors uppercase">Registra tu tienda</h3>
          <p class="text-sm text-on-surface-variant max-w-xs mt-1">Únete a la red más grande de proveedores de airsoft en Chile y aumenta tu alcance.</p>
        </button>
      </div>
    </div>
  </div>
...
<nav class="lg:hidden fixed bottom-0 left-0 w-full bg-surface border-t border-outline-variant z-50 flex justify-around items-center h-16 px-gutter">
  ...
  <a href="campos.html" class="flex flex-col items-center gap-0.5 text-on-surface-variant hover:text-on-surface">

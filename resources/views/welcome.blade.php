...
<style>
  ...
  .glass { backdrop-filter: blur(10px); background: rgba(20, 23, 26, 0.82); }
  .grid-overlay {
...
<header class="fixed top-0 w-full z-50 bg-surface border-b border-outline-variant">
  <nav class="flex justify-between items-center px-gutter h-16 max-w-container-max mx-auto">
    ...
    <div class="hidden md:flex items-center gap-xl">
      <a class="text-on-surface border-b-2 border-accent pb-1 text-sm font-medium" href="#eventos">Eventos</a>
      <a class="text-on-surface-variant hover:text-on-surface transition-colors text-sm font-medium" href="#foro">Foro</a>
      <a class="text-on-surface-variant hover:text-on-surface transition-colors text-sm font-medium" href="#mapa">Campos</a>
      <a class="text-on-surface-variant hover:text-on-surface transition-colors text-sm font-medium" href="#">Tiendas</a>
    </div>
    <div class="flex items-center gap-sm">
      <button aria-label="Buscar" class="p-2 text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface transition-colors rounded-full">
...
<div id="mobile-menu" class="fixed inset-x-0 top-[6.5rem] z-40 md:hidden bg-surface-container border-b border-outline-variant -translate-y-[150%] opacity-0 pointer-events-none">
  <div class="flex flex-col p-gutter gap-xs">
    <a href="#eventos" class="px-4 py-3 rounded-lg bg-primary-container text-on-primary-container font-medium">Eventos</a>
    <a href="#foro" class="px-4 py-3 rounded-lg text-on-surface-variant hover:bg-surface-container-high">Foro</a>
    <a href="#mapa" class="px-4 py-3 rounded-lg text-on-surface-variant hover:bg-surface-container-high">Campos</a>
...
<aside class="hidden lg:flex flex-col fixed left-0 top-[6.5rem] h-[calc(100%-6.5rem)] z-30 bg-surface-container border-r border-outline-variant w-60">
  ...
  <nav class="flex-1 flex flex-col gap-xs p-2 pt-md">
    <a class="bg-primary-container text-on-primary-container rounded-lg px-4 py-3 flex items-center gap-md text-sm font-medium" href="#">
      <span class="material-symbols-outlined text-[20px]">home</span> Inicio
    </a>
    <a class="text-on-surface-variant hover:text-on-surface hover:bg-surface-container-high px-4 py-3 rounded-lg flex items-center gap-md text-sm font-medium transition-colors" href="#eventos">
      <span class="material-symbols-outlined text-[20px]">event</span> Eventos
    </a>
    <a class="text-on-surface-variant hover:text-on-surface hover:bg-surface-container-high px-4 py-3 rounded-lg flex items-center gap-md text-sm font-medium transition-colors" href="#foro">
      <span class="material-symbols-outlined text-[20px]">forum</span> Foro
    </a>
    <a class="text-on-surface-variant hover:text-on-surface hover:bg-surface-container-high px-4 py-3 rounded-lg flex items-center gap-md text-sm font-medium transition-colors" href="#mapa">
  ...
  <div class="p-2 pb-4 border-t border-outline-variant pt-2">
    <a class="text-on-surface-variant hover:text-on-surface px-4 py-2 flex items-center gap-md text-sm transition-colors" href="#">
...
<main class="lg:pl-60 pt-[6.5rem] pb-20 lg:pb-0">
  ...
  <section class="relative h-[640px] w-full overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img class="w-full h-full object-cover" alt="Operador de airsoft en la cordillera central de Chile durante la hora dorada, portando equipo táctico y un rifle AEG realista." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBIDZXl2rvdBFuW1bc-j3U9VX5pCtIVcpgEbUc54XVhwaPYqz5oV2W6oKmxwt3dJlZvUcq7c_C7kNT0zwjCuN3-JT7qtQAuAaNi4DtpzBpfVGPV2w5QJmXjuyodR6PGIGrPFP3FIWVPAp5qW-nnfGtWwCXzvnfcCLVaLGdC0jxzVG3yzYxhUBdpHHjkeeSsshYMuZly6EJe9IOs7nYNjB1dpaM2B5UqJgo3cz1d3lm2_45C8I-RebECoA"/>
    ...
    <div class="relative z-10 h-full flex flex-col justify-end px-gutter pb-xl max-w-3xl">
      <div class="inline-flex w-fit items-center gap-1 px-3 py-1 bg-accent text-on-accent font-mono text-[11px] uppercase tracking-wide mb-md">
        <span class="material-symbols-outlined text-[14px]">bolt</span> Misión preparada
      </div>
      <h1 class="font-display text-[42px] sm:text-[56px] leading-[0.95] text-on-surface uppercase mb-md">La red del airsoft chileno</h1>
      <p class="text-on-surface-variant text-base sm:text-lg mb-lg max-w-xl leading-relaxed">
        Coordina misiones, encuentra campos verificados y conéctate con equipos de todo Chile. Todo lo que necesitas para tu próxima operación, en un solo lugar.
      </p>
      <div class="flex flex-wrap gap-md">
        <button class="bg-accent text-on-accent px-lg py-3.5 font-display text-base uppercase clipped hover:brightness-110 transition-all">
          Únete a la comunidad
        </button>
        <a href="#mapa" class="flex items-center gap-2 bg-transparent border border-outline-variant text-on-surface px-lg py-3.5 font-display text-base uppercase hover:bg-surface-container-high transition-colors">
          Ver mapa de campos
        </a>
      </div>
    </div>
  ...
  <!-- BENTO: eventos + foro -->
  <section id="eventos" class="p-gutter grid grid-cols-1 md:grid-cols-12 gap-lg max-w-container-max mx-auto scroll-mt-24">
    <div class="md:col-span-8 space-y-md">
      <div class="flex justify-between items-end border-b border-outline-variant pb-sm">
        ...
        <div class="flex gap-xs">
          <button aria-label="Anterior" class="p-1.5 border border-outline-variant rounded hover:bg-surface-container-high text-on-surface-variant hover:text-on-surface transition-colors">
            <span class="material-symbols-outlined text-[18px]">chevron_left</span>
          </button>
          <button aria-label="Siguiente" class="p-1.5 border border-outline-variant rounded hover:bg-surface-container-high text-on-surface-variant hover:text-on-surface transition-colors">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-md">
        <!-- Event 1 -->
        <article class="bg-surface-container-low border border-outline-variant rounded-lg overflow-hidden group hover:border-primary/40 transition-colors">
          <div class="h-44 relative overflow-hidden">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Campo táctico de airsoft con contenedores y barricadas de madera en zona boscosa cerca de Santiago." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBOsxQiGSr_tPvFfETxQy6xxXWHHImQCiuqsJQGmONjY2i2uk9BXqG5Rmgdmz6W2VgZVKQvktivqFVpurpnM6CPs8MNvGYysR9GXEYtb46rn3XkdhF0qSe2mF1fGsuGkcZwF3Q35PbmjVEVci-TmxsJ65MiBi3q7F5bWVV9UAcwyzR2exMjXcsII7b8-Jm2uG_MvEbG4dNtyNRyjCYBqDnA0dnS7tJQOslIC7LeyZcP_Y-DiyFBWuz0LA"/>
            <span class="absolute top-2 right-2 bg-on-surface text-surface font-mono text-[11px] px-2 py-1 uppercase rounded">24 Oct</span>
          </div>
          <div class="p-md">
            ...
            <p class="text-sm text-on-surface-variant mb-md leading-relaxed">Simulación nocturna en el valle central. Cupos limitados para equipos con visión nocturna.</p>
            <div class="flex items-center gap-md font-mono text-[11px] text-on-surface-variant">
              <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[15px]">location_on</span>Rancagua</span>
              <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[15px]">group</span>45/60</span>
            </div>
          </div>
        </article>
        ...
        <article class="bg-surface-container-low border border-outline-variant rounded-lg overflow-hidden group hover:border-primary/40 transition-colors">
          <div class="h-44 relative overflow-hidden">
            <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Jugadores de airsoft con equipo desértico reunidos en un círculo de briefing bajo el sol de la zona árida de Chile." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCk44glCCTpPt1duL5Euf5lPrir2gLI27f6ygae7VQmpociXL_P-O38ZvdTlw_4Lt2qKIQJhT4ezjTcyABdzN7oOD5npRS2Daf3popqtHkEEH3MGqEIZMUK9oFyIZvQtnjruI7U-dlFUxFCv_OV8QRlS9sVcf8mjmanCxfLYJaSHSxmn11RQ1Ac81412WSwsR0HrQ22-vy887w-2E7drg9VXMBz4eaGwIDZGjuKV-MluRsnLZfHTq446g"/>
            <span class="absolute top-2 right-2 bg-on-surface text-surface font-mono text-[11px] px-2 py-1 uppercase rounded">02 Nov</span>
          </div>
          <div class="p-md">
            <div class="flex justify-between items-start mb-xs gap-2">
            ...
            <p class="text-sm text-on-surface-variant mb-md leading-relaxed">Milsim de día completo en la franja de Atacama. Se requiere alta resistencia física.</p>
            <div class="flex items-center gap-md font-mono text-[11px] text-on-surface-variant">
              <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[15px]">location_on</span>Copiapó</span>
              <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[15px]">group</span>120/200</span>
            </div>
          </div>
        </article>
      </div>
    ...
    <!-- FORO -->
    <aside id="foro" class="md:col-span-4 bg-surface-container-high border border-outline-variant rounded-lg p-md h-fit scroll-mt-24">
      <h2 class="font-display text-xl uppercase text-on-surface border-b border-outline-variant pb-sm mb-md flex items-center gap-sm">
      ...
      <div class="space-y-md">
        <a href="#" class="group block">
          ...
          <h4 class="text-sm text-on-surface font-semibold group-hover:text-primary transition-colors leading-snug">¿Mejores pistolas GBB para climas fríos en el sur de Chile?</h4>
        ...
        <a href="#" class="group block">
          <h4 class="text-sm text-on-surface font-semibold group-hover:text-primary transition-colors leading-snug">Reseña del campo: BattleZone Santiago estrena barricadas nuevas</h4>
          <div class="flex items-center justify-between mt-sm font-mono text-[11px] text-on-surface-variant">
        ...
        <a href="#" class="group block">
          ...
          <h4 class="text-sm text-on-surface font-semibold group-hover:text-primary transition-colors leading-snug">Nuevas regulaciones legales para airsoft en 2026</h4>
          <div class="flex items-center justify-between mt-sm font-mono text-[11px] text-on-surface-variant">
            <span>539 respuestas</span><span>Hace 15m</span>
          </div>
        </a>
      </div>
      <button class="w-full mt-lg border border-outline-variant text-on-surface py-2.5 text-sm font-medium uppercase hover:bg-surface-container transition-colors rounded">
        Entrar al foro
      </button>
    </aside>
  </section>
  ...
  <section id="mapa" class="p-gutter max-w-container-max mx-auto mb-xl scroll-mt-24">
    <div class="bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden relative">
      <div class="absolute top-4 left-4 sm:top-6 sm:left-6 z-20 glass border border-outline-variant rounded-lg p-md max-w-xs">
        <h3 class="font-display text-lg text-primary uppercase mb-xs">Mapa estratégico</h3>
        <p class="text-sm text-on-surface-variant mb-md leading-relaxed">Más de 45 campos verificados en todo Chile. Disponibilidad y calificaciones en tiempo real.</p>
        <div class="space-y-sm">
          <div class="flex items-center gap-md text-sm">
            <span class="w-3 h-3 bg-primary rotate-45 shrink-0"></span><span class="font-mono text-[12px]">Arenas CQB</span>
          </div>
          <div class="flex items-center gap-md text-sm">
            <span class="w-3 h-3 bg-accent rotate-45 shrink-0"></span><span class="font-mono text-[12px]">Campos Milsim</span>
          </div>
          <div class="flex items-center gap-md text-sm">
            <span class="w-3 h-3 bg-on-surface-variant rotate-45 shrink-0"></span><span class="font-mono text-[12px]">Campos de práctica</span>
          </div>
        </div>
        <button class="w-full mt-lg bg-surface-container-high text-on-surface border border-outline-variant py-2.5 text-sm font-medium uppercase hover:bg-surface-container-high/70 transition-colors rounded">
          Filtros (0)
        </button>
      </div>

      <div class="h-[520px] w-full relative grid-overlay overflow-hidden">
        <img class="w-full h-full object-cover opacity-40 grayscale contrast-125" alt="Mapa topográfico de Chile con marcadores de ubicación de campos de airsoft." src="https://lh3.googleusercontent.com/aida-public/AB6AXuD7Jk4BirwM_t77htBHzb6TyCqcsdTshT5CTVGLHRVbg2NYp-faKvcdxab4lgwnvy3gNJi6fSZSsG1sxnojkN_lWvB9RstX52uNuxhPa3wnwTB5xm0sp3-c3L2eSh7zY7Bi5AtXWvogDAnLNRfo2Ujd8osbMJS_FGsnaLu9HBByDWH8rgQq0uI69PbGQ0X7Sn0BDCSJLGWSwyi7hVoaT0M4_LS15wqyV43tbplubh6hEqu4rqoag0UQHA"/>

        <button class="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 group" aria-label="Santiago BattleZone">
          <span class="block w-4 h-4 bg-primary rotate-45 border-2 border-surface animate-pulse"></span>
          <span class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block group-focus:block glass border border-primary rounded p-2 text-xs font-mono whitespace-nowrap">[HQ] Santiago BattleZone</span>
        </button>
        <button class="absolute top-1/2 left-1/2 translate-x-8 translate-y-12 group" aria-label="Operaciones Puerto Valparaíso">
          <span class="block w-4 h-4 bg-accent rotate-45 border-2 border-surface"></span>
          <span class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block group-focus:block glass border border-accent rounded p-2 text-xs font-mono whitespace-nowrap">Operaciones Puerto Valparaíso</span>
        </button>
        <button class="absolute bottom-1/4 left-1/2 -translate-x-20 group" aria-label="Campo Forestal Concepción">
          ...
          <span class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block group-focus:block glass border border-outline-variant rounded p-2 text-xs font-mono whitespace-nowrap">Campo Forestal Concepción</span>
        </button>

        <div class="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 z-20 flex flex-col gap-sm items-end">
          <div class="bg-surface text-on-surface-variant font-mono px-3 py-1 border border-outline-variant text-[10px] rounded">LAT -33.4489 / LONG -70.6693</div>
          <div class="bg-surface text-on-surface-variant font-mono px-3 py-1 border border-outline-variant text-[10px] rounded">12 operaciones activas</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="bg-surface-container relative py-xl px-gutter">
    <div class="max-w-container-max mx-auto flex flex-col items-center text-center">
      ...
      <p class="text-on-surface-variant max-w-xl mb-lg leading-relaxed">Accede a eventos exclusivos, foros de comercio verificados y comunicaciones regionales.</p>
      <form class="flex flex-col sm:flex-row gap-xs w-full max-w-md" onsubmit="return false">
        <label for="email" class="sr-only">Correo electrónico</label>
        <input id="email" class="flex-1 bg-surface border-0 border-b-2 border-outline-variant focus:border-accent focus:ring-0 text-on-surface font-mono text-sm px-4 py-3 placeholder:text-on-surface-variant/50 rounded-t" placeholder="Ingresar correo" type="email"/>
        <button class="bg-accent text-on-accent px-lg py-3 font-display uppercase clipped active:scale-95 transition-all">Iniciar</button>
      </form>
    </div>
  </section>
  ...
  <footer class="w-full py-xl px-gutter flex flex-col md:flex-row justify-between items-center gap-md bg-surface-container-lowest border-t border-outline-variant">
    ...
    <div class="flex gap-md">
      ...
      <a aria-label="Sitio web" class="w-10 h-10 bg-surface-container rounded-lg border border-outline-variant flex items-center justify-center text-on-surface-variant hover:text-primary transition-colors" href="#">
...
<nav class="lg:hidden fixed bottom-0 left-0 w-full bg-surface border-t border-outline-variant z-50 flex justify-around items-center h-16 px-gutter">
  <a href="#" class="flex flex-col items-center gap-0.5 text-accent">
    <span class="material-symbols-outlined text-[22px]">home</span>
    <span class="text-[10px] font-mono uppercase">Inicio</span>
  </a>
  <a href="#eventos" class="flex flex-col items-center gap-0.5 text-on-surface-variant hover:text-on-surface">
    <span class="material-symbols-outlined text-[22px]">event</span>
    <span class="text-[10px] font-mono uppercase">Eventos</span>
  </a>
  <a href="#mapa" class="flex flex-col items-center gap-0.5 text-on-surface-variant hover:text-on-surface">
    <span class="material-symbols-outlined text-[22px]">map</span>
    <span class="text-[10px] font-mono uppercase">Mapa</span>
  </a>
  <a href="#foro" class="flex flex-col items-center gap-0.5 text-on-surface-variant hover:text-on-surface">

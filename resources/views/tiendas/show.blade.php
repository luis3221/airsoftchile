...
@section('content')
  ...
  <div class="bg-surface-container border border-outline-variant rounded-lg overflow-hidden">
    ...
    <div class="p-md grid {{ $tienda->sitio_web ? 'grid-cols-3' : 'grid-cols-2' }} gap-2 border-t border-outline-variant bg-surface-container-low">
      @if ($tienda->sitio_web)
        <a href="{{ $tienda->sitio_web }}" target="_blank" rel="noopener noreferrer"

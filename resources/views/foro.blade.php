...
<style>
  ...
  #mobile-menu, #auth-modal .modal-panel { transition: transform .25s ease, opacity .2s ease; }
</style>
</head>
  ...
  <nav class="flex justify-between items-center px-gutter h-16 max-w-container-max mx-auto">
    ...
    <div class="flex items-center gap-sm">
      <div class="relative hidden sm:block">
        ...
        <input id="search-comms" class="bg-surface-container-low border border-outline-variant rounded text-on-surface text-sm py-2 pl-9 pr-3 focus:border-accent focus:ring-0 w-48 font-mono placeholder:text-on-surface-variant/60" placeholder="Buscar comms…" type="text"/>
      </div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-md mb-xl">
      <div>
        <div class="flex items-center gap-sm mb-xs">
          <span class="bg-primary text-on-primary font-mono text-[10px] px-2 py-0.5 rounded uppercase">Live comms</span>
          <span class="text-on-surface-variant font-mono text-[11px] uppercase tracking-widest">Red táctica</span>
        </div>
        <h1 class="font-display text-3xl sm:text-4xl text-on-surface uppercase tracking-tight">Foro de comando central</h1>
      </div>
      <button class="bg-accent text-on-accent px-lg py-3 font-display uppercase clipped hover:brightness-110 active:scale-95 transition-all flex items-center gap-2" onclick="toggleAuthPrompt()">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-lg items-start">
      ...
      <div class="xl:col-span-8 space-y-lg">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-sm">
          <button class="group p-md bg-surface-container-low border border-outline-variant hover:border-primary/60 transition-colors text-left flex flex-col justify-between h-28 rounded-lg">
          ...
          <button class="group p-md bg-surface-container-low border border-outline-variant hover:border-accent/60 transition-colors text-left flex flex-col justify-between h-28 rounded-lg">
        ...
        <div class="bg-surface-container border border-outline-variant rounded-xl overflow-hidden">
          <div class="bg-surface-container-high px-lg py-md border-b border-outline-variant flex justify-between items-center gap-2">
            <h2 class="font-mono text-[12px] uppercase text-primary tracking-wide">Inteligencia reciente / hilos</h2>
            <div class="flex items-center gap-2">
              <label for="sort-threads" class="font-mono text-[11px] text-on-surface-variant uppercase hidden sm:block">Ordenar</label>
              <select id="sort-threads" class="bg-transparent border-none font-mono text-[12px] text-on-surface p-0 cursor-pointer focus:ring-0">
          ...
          <ul class="divide-y divide-outline-variant">
            <li>
              <a href="#" class="group px-lg py-md flex items-center gap-md hover:bg-surface-container-high transition-colors">
                <img class="w-10 h-10 rounded object-cover border border-outline-variant shrink-0" alt="Avatar de Viper_Operator, jugador de airsoft con equipo multicam." src="https://lh3.googleusercontent.com/aida-public/AB6AXuC6QbgfbmE0ZTBgi30lQNr6LPYtZYQTb8JhJVbJ4bodurRCW1IdlS0IxRwwukCUQriWksPny3RcJulzl7W8XOruIWqTQ6hNMpV4wMvnOroo7ugAwFec1aRHKx7FMAwY4b1aNVhI5NHzl3SNOFCmduzvo2LJyCIToiLEK8BDSzf3lIO05D4geSVXaW6LsLRsbfi8F3vegBT7NC5txOv9amByV7NBrFm9bRUHMygJq7POgvc8rNj_SApPig"/>
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2 mb-1">
                    <span class="font-mono text-[10px] text-accent border border-accent/40 px-1.5 py-0.5 rounded uppercase">Fijado</span>
                    <h3 class="font-display text-base text-on-surface truncate group-hover:text-primary transition-colors uppercase">Guía: mantenimiento preventivo de GBBR (2026)</h3>
                  </div>
                  <div class="flex items-center gap-md text-on-surface-variant text-sm flex-wrap">
                    ...
                    <span>Hace 24m</span>
                    <span class="hidden md:inline-flex items-center gap-1"><span class="material-symbols-outlined text-[15px]">comment</span>142</span>
                  </div>
                </div>
            ...
            <li>
              <a href="#" class="group px-lg py-md flex items-center gap-md hover:bg-surface-container-high transition-colors">
                <img class="w-10 h-10 rounded object-cover border border-outline-variant shrink-0" alt="Avatar de Ghost_CL, jugador con pasamontañas y gafas tácticas." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDZJV4EW1EpOcpE4WKuc_s6jiJ9lebhdG58UJcG00HqT9qr8RN0O4zlb_sd0zd2yr8Q4fbAfIarrg0_W3SG9vsEJwbW40kWvepCopWvN_LA03-Yp18tSdu_CaNK7rLQ6j-80ap4bNxmbTOzix-4E5csxNzPrOVOjzJwKifUlbLwXMc0D4Ehmc_WlACCxceLQfMquoi-hqwMusy2aUGIyiL3kFDTkn4au3kWNlZJpZyI___yVdVdYZchDg"/>
                <div class="flex-1 min-w-0">
                  <h3 class="font-display text-base text-on-surface truncate group-hover:text-primary transition-colors uppercase mb-1">[Vendo] Tokyo Marui MWS + 4 cargadores</h3>
                  <div class="flex items-center gap-md text-on-surface-variant text-sm flex-wrap">
                    <span>Por <span class="text-primary">Ghost_CL</span></span>
                    <span>Hace 1h</span>
                    <span class="hidden md:inline-flex items-center gap-1"><span class="material-symbols-outlined text-[15px]">comment</span>12</span>
                  </div>
                </div>
                <div class="hidden md:flex flex-col items-end shrink-0">
                  <span class="font-mono text-[10px] text-on-surface-variant uppercase">Actividad</span>
            ...
            <li>
              <a href="#" class="group px-lg py-md flex items-center gap-md hover:bg-surface-container-high transition-colors">
                <img class="w-10 h-10 rounded object-cover border border-outline-variant shrink-0" alt="Avatar de Coyote_1, jugador con chaleco táctico y parche de la bandera chilena." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAAg_ukF23uDpgUt-PJpHgu4BnvR96jF54WUEMLrCE_NS8RzygWTk2gFcqUz8SeK7cqmhWW-5eeSkKxM9F-J4ytXUVt_MquhkBZQvrQhlq3ydYGa7VRMILjEQF0YRm-GMesv3tjiH5WgwUGxG8PGunTjjldFhgG3xC3F-wGVYpRSkOF7KXBTe5jlVqm6k2lVf7_SHIrlnWL4qJzduGZ-5rPr62bf_-U9ZWxsio9MQDTNxD7wUKnu4Ag8Q"/>
                <div class="flex-1 min-w-0">
                  <h3 class="font-display text-base text-on-surface truncate group-hover:text-primary transition-colors uppercase mb-1">Nuevo campo en Melipilla: ¿alguien lo conoce?</h3>
                  <div class="flex items-center gap-md text-on-surface-variant text-sm flex-wrap">
                    <span>Por <span class="text-primary">Coyote_1</span></span>
                    <span>Hace 4h</span>
                    <span class="hidden md:inline-flex items-center gap-1"><span class="material-symbols-outlined text-[15px]">comment</span>45</span>
                  </div>
                </div>
                <div class="hidden md:flex flex-col items-end shrink-0">
                  <span class="font-mono text-[10px] text-on-surface-variant uppercase">Actividad</span>
            ...
            <li>
              <a href="#" class="group px-lg py-md flex items-center gap-md hover:bg-surface-container-high transition-colors">
                <img class="w-10 h-10 rounded object-cover border border-outline-variant shrink-0" alt="Avatar de Nightfall, operador con camuflaje digital woodland y auriculares tácticos." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBqocGFfEUpNfihdJamaQRObCKgRVXWnDF6c3YmjDviAleZBNFsfgnrKtnoWf8q1BEmxAMrja_5jhsFY4b8vrEBHMtzrGz_RZYr9tuhwy6RjLjFhzWt2-qopoOleMMRNJoi4YkJO-65Q95A9GLBCgnfR7mjUNctVO36uqbEzM1dcELKw46XwSuUs6r6RbtKdBWCV0Lpw3LMzidZXWNnNn5zGKmwzwsZ89tAu3e6SOto-ZzWfswNcSH5Ow"/>
                <div class="flex-1 min-w-0">
                  <h3 class="font-display text-base text-on-surface truncate group-hover:text-primary transition-colors uppercase mb-1">Debate: ¿HPA vs AEG en Milsim de larga duración?</h3>
                  <div class="flex items-center gap-md text-on-surface-variant text-sm flex-wrap">
                    <span>Por <span class="text-primary">Nightfall</span></span>
                    <span>Hace 6h</span>
                    <span class="hidden md:inline-flex items-center gap-1"><span class="material-symbols-outlined text-[15px]">comment</span>89</span>
                  </div>
                </div>
                <div class="hidden md:flex flex-col items-end shrink-0">
                  <span class="font-mono text-[10px] text-on-surface-variant uppercase">Actividad</span>
          ...
          <div class="bg-surface-container-high p-md text-center">
            <button class="text-primary font-mono text-[12px] hover:underline uppercase tracking-widest">Cargar más comunicaciones</button>
          </div>
        </div>
      </div>
      ...
      <aside class="xl:col-span-4 space-y-lg">
        ...
        <!-- Online members -->
        <div class="bg-surface-container border border-outline-variant rounded-xl overflow-hidden">
          <div class="bg-primary-container/40 border-b border-primary/20 px-lg py-md flex justify-between items-center">
          ...
          <div class="p-lg">
            <div class="flex flex-wrap gap-sm">
              <span class="flex items-center gap-1.5 bg-surface-container-high px-2 py-1 rounded border border-outline-variant text-sm">
              ...
              <span class="flex items-center gap-1.5 bg-surface-container-high px-2 py-1 rounded border border-outline-variant text-sm text-on-surface-variant">
          ...
          <div class="p-lg space-y-md">
            <div class="flex gap-md">
              ...
              <p class="text-sm text-on-surface-variant leading-relaxed">
                <strong class="text-on-surface">La honestidad es lo primero.</strong> El airsoft se basa en el honor: cualquier reporte de trampa en campos será sancionado en el foro.
              </p>
            </div>
            <div class="flex gap-md">
              <span class="font-mono text-primary text-lg leading-none">02</span>
              <p class="text-sm text-on-surface-variant leading-relaxed">
                <strong class="text-on-surface">Sin réplicas reales.</strong> Prohibido publicar armas de fuego reales o accesorios restringidos por ley.
              </p>
            </div>
            <div class="flex gap-md">
              <span class="font-mono text-primary text-lg leading-none">03</span>
              <p class="text-sm text-on-surface-variant leading-relaxed">
                <strong class="text-on-surface">Categorización.</strong> Mantén los hilos en su sección correspondiente para facilitar la navegación.
              </p>
            </div>
            <button class="w-full border border-outline-variant hover:bg-surface-container-high py-2.5 rounded text-sm font-medium transition-colors text-on-surface-variant uppercase tracking-wide">
        ...
        <a href="#" class="relative group block h-44 rounded-xl overflow-hidden border border-outline-variant">
          <img class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Vitrina de tienda de equipamiento táctico con réplicas de airsoft de alta gama iluminadas." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAjANhbHWwmUMFdUCyo2nN4mkptBiLaOfxbg1Pob42endu4yFEHajfDlmaMj12JiIls31zWdPdvhYZRYvrxy6CbJJibkZphE9cn-aB1Z0X-35YJlPhL2yRxGstmmebflXnyUbNSdWaxf_-Bd2NK05eat62jYWklS03Fj1PwNuXG0_VFu0FotbsMis--WIcHM1VNPhDjrRTPTE-3GebZQALbUDxecYxtqzZGQI_3oiwg4-rI0Rkdh4YZNg"/>
          ...
          <div class="absolute bottom-0 left-0 p-md">
            <span class="bg-accent text-on-accent font-mono text-[10px] px-2 py-0.5 rounded uppercase mb-2 inline-block">Contenido patrocinado</span>
...
<footer class="lg:pl-60 w-full py-xl px-gutter flex flex-col md:flex-row justify-between items-center gap-md bg-surface-container-lowest border-t border-outline-variant">
  ...
  <div class="flex gap-md">
    <a aria-label="RSS" class="w-10 h-10 bg-surface-container rounded-lg border border-outline-variant flex items-center justify-center text-on-surface-variant hover:text-primary transition-colors" href="#">
...
<div class="fixed inset-0 z-[100] hidden items-center justify-center px-gutter" id="auth-modal">
  ...
  <div class="modal-panel relative w-full max-w-md bg-surface-container border border-outline-variant p-xl rounded-xl clipped shadow-2xl" role="dialog" aria-modal="true" aria-labelledby="auth-title">
    <div class="flex flex-col items-center text-center mb-lg">
      ...
      <p class="text-on-surface-variant mt-sm">Debes ser un operador registrado para iniciar una nueva publicación.</p>
    </div>
    <div class="space-y-sm">
      <button class="w-full bg-primary text-on-primary py-3 rounded font-medium uppercase tracking-wide hover:brightness-110 transition-all">Iniciar sesión</button>
      <button class="w-full border border-outline-variant text-on-surface py-3 rounded font-medium uppercase tracking-wide hover:bg-surface-container-high transition-colors">Solicitar alistamiento (registrarse)</button>
    </div>
    <button class="mt-lg text-on-surface-variant font-mono text-[11px] uppercase hover:text-primary w-full text-center transition-colors" onclick="toggleAuthPrompt()">Abortar operación</button>
  </div>
</div>
